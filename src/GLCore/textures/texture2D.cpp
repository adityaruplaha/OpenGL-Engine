...
Texture2D::Texture2D(std::string path, GLenum image_format, GLint filtering,
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, surface->width, surface->height, 0, image_format,
                 GL_UNSIGNED_BYTE, surface->getData());
